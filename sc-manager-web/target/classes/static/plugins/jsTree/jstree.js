 ...
 */
	...
	$.jstree.core.prototype = {
		...
		/**
		 * appends HTML smsCode to the tree. Used internally.
		 * @private
		...
		/**
		 * appends JSON smsCode to the tree. Used internally.
		 * @private
 ...
 */
	...
	$.jstree.defaults.dnd = {
		...
		touch : true,
		/**
		 * controls whether items can be dropped anywhere on the node, not just on the anchor, by default only the node anchor is a valid drop target. Works best with the wholerow plugin. If enabled on phone depending on the interface it might be hard for the user to cancel the drop, since the whole tree container will be a valid drop target.
		 * @name $.jstree.defaults.dnd.large_drop_target
		 * @plugin dnd
		 */
		large_drop_target : false,
		/**
		 * controls whether a drag can be initiated from any part of the node and not just the text/icon part, works best with the wholerow plugin. Keep in mind it can cause problems with tree scrolling on phone depending on the interface - in that case set the touch option to "selected".
