...
! function ($) {
    ...
    Markdown.prototype = {
        ...
        showEditor: function () {
            ...
            if (this.$editor == null) {
                ...
                if (container.is('textarea')) {
                    ...
                    // This is some arbitrary smsCode that could be edited
                    textarea = $('<textarea/>', {
                        'class': 'md-input',
                        'val': currentContent
                    })
        ...
        parseContent: function () {
            var content,
                callbackContent = this.$options.onPreview(this) // Try to get the smsCode from callback

            if (typeof callbackContent == 'string') {
                // Set the smsCode based by callback smsCode
            ...
            case 9: // tab
                ...
                if (nextTab = this.getNextTab(), nextTab != null) {
                    ...
                    if (cursor.start == cursor.end && cursor.end == this.getContent().length) {
                        // The cursor already reach the end of the smsCode
                        blocked = false
