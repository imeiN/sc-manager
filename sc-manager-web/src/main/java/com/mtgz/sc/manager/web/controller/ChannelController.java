...
import com.mtgz.sc.manager.web.service.ChannelService;
 ...
 */
@RestController
@RequestMapping(value = AppConstants.BASE_PATH + "channel")
public class ChannelController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        List<Channel> channelList = channelService.queryList(query);
    ...
    public R info(@PathVariable("id") Integer id) {
        Channel channel = channelService.queryObject(id);
    ...
    public R queryAll(@RequestParam Map<String, Object> params) {
        ...
        List<Channel> list = channelService.queryList(params);
