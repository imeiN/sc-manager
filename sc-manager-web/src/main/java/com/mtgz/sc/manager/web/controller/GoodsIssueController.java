...
import com.mtgz.sc.manager.web.service.GoodsIssueService;
 ...
 */
@RestController
@RequestMapping(value = AppConstants.BASE_PATH + "goodsissue")
public class GoodsIssueController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        List<GoodsIssue> goodsIssueList = goodsIssueService.queryList(query);
