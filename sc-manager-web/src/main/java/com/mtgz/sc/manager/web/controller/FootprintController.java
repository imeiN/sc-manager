...
import com.mtgz.sc.manager.web.service.FootprintService;
...
public class FootprintController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        List<Footprint> footprintList = footprintService.queryList(query);
    ...
    public R update(@RequestBody Footprint footprint) {
