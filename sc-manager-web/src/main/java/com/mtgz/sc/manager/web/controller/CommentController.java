...
import com.mtgz.sc.manager.web.service.CommentService;
...
public class CommentController {
    ...
    public R queryAll(@RequestParam Map<String, Object> params) {
        ...
        List<Comment> list = commentService.queryList(params);
    ...
    public R toggleStatus(@RequestBody Comment comment) {
