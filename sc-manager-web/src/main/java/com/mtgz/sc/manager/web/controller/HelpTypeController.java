...
import com.mtgz.sc.manager.web.service.HelpTypeService;
 ...
 */
@Controller
@RequestMapping(value = AppConstants.BASE_PATH + "helptype")
public class HelpTypeController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        List<HelpType> helpTypeList = helpTypeService.queryList(query);
    ...
    @ResponseBody
    public R update(@RequestBody HelpType helpType) {
