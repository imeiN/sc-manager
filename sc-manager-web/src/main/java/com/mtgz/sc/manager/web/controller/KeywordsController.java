...
import com.mtgz.sc.manager.web.service.KeywordsService;
 ...
 */
@RestController
@RequestMapping(value = AppConstants.BASE_PATH + "keywords")
public class KeywordsController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        List<Keywords> keywordsList = keywordsService.queryList(query);
