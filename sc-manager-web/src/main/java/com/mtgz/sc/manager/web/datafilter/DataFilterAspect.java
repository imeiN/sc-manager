package com.mtgz.sc.manager.web.datafilter;//package com.mtgz.sc.manager.web.datafilter;
//
...
//     * 切点
//     */
//    @Pointcut("@annotation(com.mtgz.sc.manager.web.datafilter.DataFilter)")
...
//        List<Long> roleOrglist = sysClient.queryDeptIdListByUserId(userId);
