...
import com.mtgz.sc.manager.common.entity.SysLogEntity;
import com.mtgz.sc.manager.dao.mapper.SysLogMapper;
...
public class SysLogService {
    ...
    public List<SysLogEntity> queryList(Map<String, Object> map) {
        List<SysLogEntity> list = sysLogMapper.queryList(map);
