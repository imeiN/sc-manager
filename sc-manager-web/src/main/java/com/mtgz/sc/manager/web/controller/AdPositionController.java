...
import com.mtgz.sc.manager.web.service.AdPositionService;
 ...
 */
@RestController
@RequestMapping(value = AppConstants.BASE_PATH + "adposition")
public class AdPositionController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        List<AdPosition> adPositionList = adPositionService.queryList(query);
