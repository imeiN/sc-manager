...
import com.mtgz.sc.manager.web.service.HelpIssueService;
...
public class HelpIssueController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        List<HelpIssue> helpIssueList = helpIssueService.queryList(query);
    ...
    @ResponseBody
    public R update(@RequestBody HelpIssue helpIssue) {
    ...
    public R queryAll(@RequestParam Map<String, Object> params) {
        ...
        List<HelpIssue> list = helpIssueService.queryList(params);
