...
import com.mtgz.sc.manager.web.service.SpecificationService;
 ...
 */
@RestController
@RequestMapping(value = AppConstants.BASE_PATH + "specification")
public class SpecificationController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        List<Specification> specificationList = specificationService.queryList(query);
